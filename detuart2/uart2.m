 ...
 *(.text)
 ...
 .text          0x000000b4       0x68 uart2.o
                0x000000b4                PortInit
                0x000000bc                USART_Init
                0x000000d6                UART_Prano
                0x000000de                UART_Dergo
                0x000000e6                main
 ...
 *(.debug_aranges)
 .debug_aranges
                0x00000000       0x20 uart2.o

.debug_pubnames
                0x00000000       0x5d
 *(.debug_pubnames)
 .debug_pubnames
                0x00000000       0x5d uart2.o

.debug_info     0x00000000      0x118
 *(.debug_info)
 .debug_info    0x00000000      0x118 uart2.o
 *(.gnu.linkonce.wi.*)

.debug_abbrev   0x00000000       0xe4
 *(.debug_abbrev)
 .debug_abbrev  0x00000000       0xe4 uart2.o

.debug_line     0x00000000      0x159
 *(.debug_line)
 .debug_line    0x00000000      0x159 uart2.o

.debug_frame    0x00000000       0x60
 *(.debug_frame)
 .debug_frame   0x00000000       0x60 uart2.o

.debug_str      0x00000000       0xbb
 *(.debug_str)
 .debug_str     0x00000000       0xbb uart2.o
...
.debug_macinfo
 *(.debug_macinfo)
OUTPUT(uart2.elf elf32-avr)
LOAD linker stubs

.debug_pubtypes
                0x00000000       0x1e
 .debug_pubtypes
                0x00000000       0x1e uart2.o
